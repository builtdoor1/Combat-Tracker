...
/**
 * Generates the Combat Tracker mod icon: the aim-placement scatter, which is the
 * mod's most recognisable output. Green landed / red whiffed dots clustered inside
 * a player hitbox drawn to scale.
 *
 * Run: java IconGen.java <out.png> [size]
 */
public class IconGen {
    // Same palette the report and viewer use.
    ...
    public static void main(String[] args) throws Exception {
        ...
        double s = size / 256.0;   // everything below is authored at 256 and scaled
        ...
        // ── Player hitbox, 0.6 x 1.8 blocks kept in proportion ────────────────
        ...
        // ── Scatter ───────────────────────────────────────────────────────────
        // Tight vertically-elongated cluster with a looser halo of whiffs, which is
        // what a real session looks like: aim spread over the body, misses outside.
        ...
        for (int i = 0; i < 165; i++) {
            ...
            // Inside the hitbox reads mostly as a landed hit, outside as a whiff.
        ...
        // ── Border on top so the scatter never bleeds over the edge ───────────
        g.setClip(null);
        g.setColor(BORDER);
