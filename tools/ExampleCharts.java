...
/**
 * Generates the side-by-side comparison figures used on the Modrinth page: what
 * each chart looks like for a human, and what it looks like for the cheat that
 * chart exists to detect.
 *
 * These are illustrative, not captures of real sessions. They are drawn in the
 * same visual language as the report so the page matches what people will see.
 *
 * Run: java ExampleCharts.java <outDir>
 */
