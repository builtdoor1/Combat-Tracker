...
public class HudRenderer {
    ...
    public static void renderScaledAt(GuiGraphics graphics, int x, int y) {
        // Before 1.21.9 the GUI transform is a 3D PoseStack rather than a 2D
        // Matrix3x2fStack, so the translate and scale need a Z and the push/pop
        // are named differently. The same transform either way.
    ...
    private static List<Line> buildLines() {
        ...
        // The input-provenance counts are deliberately not shown here. Telling a
        // player in real time which of their actions were flagged tells a cheat
        // exactly which of its behaviours to stop, and the counts are kept in full
        // in the report and the share link where they are actually read.
        return lines;
    }
